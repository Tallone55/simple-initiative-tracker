...
from app_metadata import APP_NAME, VERSION, VERSION_DATE, RUNNING_FROM_SOURCE, MAINTAINER, MAINTAINER_EMAIL, REPO_URL
...
class AppWindow(Gtk.ApplicationWindow):
    ...
    def on_about(self, action, param):
        ...
        version_suffix = "-source" if RUNNING_FROM_SOURCE else ""
        about.set_version(f"{VERSION}{version_suffix} ({VERSION_DATE})")
